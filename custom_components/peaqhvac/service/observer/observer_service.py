...
from custom_components.peaqhvac.service.observer.const import TIMEOUT, COMMAND_WAIT
from custom_components.peaqhvac.service.observer.observer_model import ObserverModel
